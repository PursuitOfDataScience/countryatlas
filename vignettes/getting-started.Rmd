...
Income is a factor whose levels are already in income order, so a categorical
fill reads naturally:

```{r eval = has_maps, fig.alt = "World map coloured by World Bank income group."}
...
Or search the full World Bank catalogue by name — offline, against `WDI`'s
bundled indicator cache:
